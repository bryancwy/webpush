...
trait HasPushSubscriptions
{
    ...
    {
        return $this->hasMany(PushBrowserSubscription::class);
    }
     ...
     * @return \NotificationChannels\WebPush\PushBrowserSubscription
     */
    public function updatePushSubscription($endpoint, $key = null, $token = null)
    {
        $subscription = PushBrowserSubscription::findByEndpoint($endpoint);
        ...
        return $this->pushSubscriptions()->save(new PushBrowserSubscription([
            'endpoint' => $endpoint,
            'public_key' => $key,
            'auth_token' => $token,
        ]));
     ...
     *
     * @param  \NotificationChannels\WebPush\PushBrowserSubscription $subscription
     * @return bool
     */
